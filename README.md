...
![image](https://user-images.githubusercontent.com/67593261/148640083-0e0bb5e9-7146-4c0a-a1b4-8a4eb8064936.png) 
(in the top right), make your additions in your 'own version', and then create a pull request (definition below) to put it back into this main version! I'll review it and then add it in. 😄
...
Not to be confused with [template](#template-(code)-- "See template definition") explained below.
