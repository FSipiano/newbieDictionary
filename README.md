...
In my ['what ** is**' series] on dev.to(https://dev.to/javascriptcoff1/series/10250), where I explore common tech terms such as 'API' and 'hoisting' as well as technologies such as Vue, Tailwind and Docker!
...
Not to be confused with [template](#template-(code)-- "See template defitinion") explained below.
